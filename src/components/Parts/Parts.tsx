    ...
    <Container className="mt-20 text-center items-center font-montserrat">
      <div className=" flex flex-col items-center">
        ...
        <div className="flex flex-row mt-24 max-w-[857px]" >
          <Image width={240} height={163} className="hidden xl:block" src="/step01.png" alt="part" />
        ...
        <div className="flex flex-row mt-[90px] max-w-[857px]">
          ...
          <Image width={240} height={163} className="hidden xl:block" src="/step02.png" alt="part" />
        </div>
        <div className="flex flex-row mt-[90px] max-w-[857px]">
          <Image width={240} height={163} className="hidden xl:block" src="/step03.png" alt="part" />
        ...
        <div className="flex flex-row mt-[90px] max-w-[857px]">
          ...
          <Image width={240} height={163} className="hidden xl:block" src="/step04.png" alt="part" />
        </div>
        <div className="flex flex-row mt-[90px] max-w-[857px]">
          <Image width={240} height={163} className="hidden xl:block" src="/step05.png" alt="part" />
